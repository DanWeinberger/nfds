...
nf.obj <- list('sample.GPSCs'=sample.GPSCs,'sample.year'=sample.year, 'sample.serotypes'=sample.serotypes,'gene.mat.pre'=gene.mat.pre.only,'gene.mat'=gene.mat, 'set.vts'=set.vts,'set.rr'=set.rr, 'post.serotypes'=serotypes.post, country='US_MA')
