...
pred.comp <- merge(pred.here, pred.orig, by='SC')
pred.comp <- merge(pred.comp, obs.freq.post, by='SC')
pred.comp <- merge(pred.comp, obs.freq.pre, by='SC')
...
##Hmm
plot(gpsc.freq.comp$obs.freq.pre, gpsc.freq.comp$obs.freq.post)
abline(a=0, b=1)
